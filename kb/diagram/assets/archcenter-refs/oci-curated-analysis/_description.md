# Cloud data lake house - process enterprise and streaming data

- Source: https://docs.oracle.com/en/solutions/oci-curated-analysis/index.html
- Date: 2024-02
...
Full data lakehouse with batch and streaming ingestion. ADW with auto-scaling for curated layer. Hybrid partitioned tables to move cold data to Object Storage transparently. GoldenGate Stream Analytics for real-time event processing.
